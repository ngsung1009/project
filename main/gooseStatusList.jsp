...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <table width="100%" border="0"><tr><td>Goose 현황<small></small></td>
        ...
        <div class="col-xs-12" >
            ...
            <div class="box">
               ...
               <!-- 엑세스스위치 시작 -->
            	...
            	<section class="content-header">
			        <h1>
			            <small><label>Goose 현황</label></small><button type="button" style="float: right;" class="btn btn-primary">CSV파일저장</button>
			        </h1>
			    </section>
				<br/>
		        <div class="clearfix" ></div>
	                        ...
	                        <tr>
	                            <th class="secondary-text hidden-xs">
	                                <div class="table-header">
	                                    <span class="column-title">IED이름</span>
	                                </div>
	                            </th>
								<th class="secondary-text hidden-xs">
	                                <div class="table-header">
	                            ...
	                            <th class="secondary-text">
	                                <div class="table-header">
	                                    <span class="column-title">GOCB주소</span>
	                                </div>
	                            </th>
	                            <th class="secondary-text">
	                                <div class="table-header">
	                                    <span class="column-title">DataSet주소</span>
	                                </div>
	                            </th>
	                            <th class="secondary-text hidden-xs">
	                                <div class="table-header">
								...
								<th class="secondary-text">
	                                <div class="table-header">
	                                    <span class="column-title">최대주기</span>
	                                </div>
	                            </th>
	                            
								<th class="secondary-text">
	                                <div class="table-header">
	                                    <span class="column-title">최소주기</span>
	                                </div>
	                            </th>
