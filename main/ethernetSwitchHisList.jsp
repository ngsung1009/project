     	...
     	frm = document.switchForm;
     	 var file = $("#startTime").val();
	   	 ...
	   	 if(file == "" || file == null){
         	...
         	frm.action = "<c:url value='/ethernetSwitchHisList.do'/>";
            frm.submit();
     }
    </script>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            이더넷스위치 이력
            <small></small><button style="float: right;" type="button" onclick="location.href='<c:url value='/ethernetSwitchList.do'/>' " class="btn btn-primary">이더넷스위치</button>
        </h1>
    ...
    <section class="content">
        ...
        <div class="col-xs-12" >
            ...
            <div class="box">
                ...
                <form action="mainHeader" name="switchForm" id="switchForm" method="POST">
                <table  border="0">
                    <tr style="height: 40px">
                        ...
                        <td width="180" class=""><input type="text" id="searchKeyword" name="searchKeyword"></td>
                        <td width="40" align="right"><button type="button" class="btn btn-primary" onclick="javascript:fn_switch_search();">검색</button></td>
                    </tr>
                 </table>
            	...
            	<div class="box-body">
            	<section class="content-header">
			        <h1><small><label>History List</label></small><button type="button" style="float: right;" onclick="javascript:exportTableToCsv('tbl1','switchHistoryList');" class="btn btn-primary">CSV파일저장</button> &nbsp; <!-- button type="button" style="float: right;" class="btn btn-primary">전체목록</button--></h1>
