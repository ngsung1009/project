...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <table width="100%" border="0"><tr><td>엔지니어링검사<small></small></td>
            <td width="110"><button style="float: right;" type="button" onclick="location.href='<c:url value='/sclReportList.do'/>' " class="btn btn-primary">SCL/Report 검사</button></td>
        ...
        <div class="col-xs-12" >
            ...
            <div class="box">
               ...
               <!-- 엑세스스위치 시작 -->
            	...
            	<section class="content-header">
			        <h1>
			        	<table width="100%" border="0"><tr><td><small>엔지니어링검사</small></td>
			            <td width="110"><button style="float: right;" type="button" class="btn btn-primary">Report 스캔시작</button></td>
			            <td width="135"><button style="float: right;" type="button" class="btn btn-primary">SCL 유효성검사</button></td>
			            </tr></table>
		            ...
		            <div class="box">
	                    ...
	                    <thead>
	                        <tr>
								...
								<th class="secondary-text hidden-xs">
	                                <div class="table-header">
	                                    <span class="column-title">SA상위운영장치</span>
	                                </div>
	                            </th>
